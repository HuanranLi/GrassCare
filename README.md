...
* Notebook version is also available for finding the best embedding for clusters' path, please refer [Notebook_demo.ipynb](https://github.com/HuanranLi/GrassCare-Plot/blob/main/Notebook_demo.ipynb).
